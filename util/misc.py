...
import torchvision
try:
    torchvision_version = float('.'.join(torchvision.__version__.split('.')[:2]))
except:
    torchvision_version = float(torchvision.__version__[:3])
...
if torchvision_version < 0.7:
    try:
        ...
        # For newer versions, these are no longer needed
        pass
